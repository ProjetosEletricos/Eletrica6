...
public class GenericTableModel<T> extends AbstractTableModel {
	 ...
	 * determinar quantas linhas ele deve exibir. Este m�todo deve ser r�pido, como
	 * � chamado com freq��ncia durante o processamento.
	 * 
					...
					if (field.isAnnotationPresent(Column.class)) {
						...
						if (c != null && nowPosition == columnIndex) {
							if (field.getName().equalsIgnoreCase(field.getName())) {
								return String.format(c.formatter(), field.get(object));
							}
						}
					}

package br.aplicacao.eletrica.uteis.tableModel;
...
public class GenericTableModel2 extends AbstractTableModel {
	...
	public GenericTableModel2(List<?> lista, Class<?> classe) {
		this.list = lista;
		this.clazz = classe;
	...
	/**Retorna o n�mero de colunas no modelo. A JTable usa esse m�todo para determinar quantas colunas ele deve criar e exibir por padr�o.
	...
	/**Retorna o n�mero de linhas no modelo. A JTable usa esse m�todo para determinar quantas linhas ele deve exibir. 
	 * Este m�todo deve ser r�pido, como � chamado com freq��ncia durante o processamento.
	...
	/**Retorna o nome da coluna no columnIndex . Este � usado para inicializar o nome do cabe�alho da coluna da tabela. 
	   Nota: este nome n�o precisa ser exclusivo, duas colunas de uma tabela pode ter o mesmo nome.

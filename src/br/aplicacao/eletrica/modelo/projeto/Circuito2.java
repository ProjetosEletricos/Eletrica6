...
@Table(name = "Circuito")
@TableModel
public class Circuito2 implements Entidade<Circuito2> {
	@Id
	...
	@Override
	public Circuito2 copiar() {
		Circuito2 c = new Circuito2();
		c.setId(id);
		c.setNome(nome);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			...
			return false;
		final Circuito2 other = (Circuito2) obj;
		if (id == null) {
			if (other.id != null)
				return false;
